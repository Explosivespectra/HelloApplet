...
public class PredicateServlet extends HttpServlet
{
    ...
    throws ServletException, IOException
    {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>SWE 432 Assignment 3 Jonah Oentung</title>");
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>SWE 432 Assignment 3 Jonah Oentung</h1>");
        out.println("<hr>");
        out.println("<hr>");
        ...
        out.println("<p><strong><ul><li>No more than five predicates may be accepted</li><li>Variables and boolean operators should be split apart by at least a single space</li><li>Variables may not consist of non-alphabetical or non-numerical characters</li><li>Maximum length of variable names is 15 characters</li></ul></strong></p>");
        out.println("<hr>");
        out.println("<hr>");
        out.println("<p>");
